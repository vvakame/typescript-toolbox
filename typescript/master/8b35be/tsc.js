...
(function (ts) {
    ts.Diagnostics = {
        ...
        An_object_member_cannot_be_declared_optional: { code: 1160, category: 1 /* Error */, key: "An object member cannot be declared optional." },
    ...
    function createSourceFile(filename, sourceText, languageVersion, version, isOpen) {
        ...
        function parsePropertyAssignment() {
            ...
            if (token === 49 /* QuestionToken */) {
                ...
                grammarErrorAtPos(questionStart, scanner.getStartPos() - questionStart, ts.Diagnostics.An_object_member_cannot_be_declared_optional);
                nextToken();
            }
...
//# sourceMappingURL=file:////Users/vvakame/work/typescript/built/local/tsc.js.map